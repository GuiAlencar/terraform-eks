...
| [helm_chart.eks_helm_controller](https://registry.terraform.io/providers/hashicorp/helm/latest/docs/resources/chart) | resource |
...
| <a name="input_oidc"></a> [oidc](#input\_oidc) | HTTPS URL for the OIDC provider for the EKS cluster | `string` | n/a | yes |
